    ...
    */
    public function fetchOrdersData()
    {
        ...
        $status = isset($value['status']) ? $value['status'] : '';
            ...
            //     $paid_status = '<span class="label label-success">Active</span>'; 
            // }
            // else {
            //     $paid_status = '<span class="label label-warning">In Active</span>';
            // }
    ...
    */
    public function printDiv($id)
    {
        ...
        if($id) {
            ...
            <body>
            <div>
	<button class="btn btn-primary pri-btn"><span class="fa fa-print"></span>Print</button>
</div>
            <div class="wrapper">
                  ...
                  <div class="col-xs-6 pull pull-right">
                    ...
                    <div class="table-responsive">
                      <table class="table">
                        <tr>
                        <script>
                        var printBtn = document.querySelector(`.pri-btn`);
