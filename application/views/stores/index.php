    ...
    <div class="modal-content">
      ...
      <form role="form" action="<?php echo base_url('stores/update') ?>" method="post" id="updateForm">
        ...
        <div class="modal-body">
          ...
          <div class="form-group">
            <label for="edit_brand_name">Address</label>
            <input type="text" class="form-control" id="edit_address_name" name="edit_address_name" placeholder="Enter store name" autocomplete="off">
          </div>
          <div class="form-group">
            <label for="edit_brand_name">Phone</label>
            <input type="text" class="form-control" id="edit_phone_number" name="edit_phone_number" placeholder="Enter store name" autocomplete="off">
          </div>
          <div class="form-group">
